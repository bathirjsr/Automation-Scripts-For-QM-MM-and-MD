...
close \$myfile
atomselect top "(resname $resname and not backbone and not type HA H) or (resname $substrate and not backbone and not type HA H CB CD CG HD2 HD3 HB2 HB3 HG2 HG3)"
atomselect1 num
...
close \$myfile1
atomselect top "resname $resname $substrate and type HA or resname FE1 or (resname MOH and name O) or resname SC1 and name C1 "
set id [atomselect2 get resid]
set name [atomselect2 get resname]
