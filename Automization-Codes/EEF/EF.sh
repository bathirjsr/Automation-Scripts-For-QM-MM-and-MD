...
z1=$(awk '$4 == "FE1" && $3 == "FE" {print $8}' im.opt.pdb)

#x2=$(awk '$4 == "O11" && $3 == "O1" {print $6}' im.opt.pdb)
#y2=$(awk '$4 == "O11" && $3 == "O1" {print $7}' im.opt.pdb)
#z2=$(awk '$4 == "O11" && $3 == "O1" {print $8}' im.opt.pdb)
...
cp im.opt.pdb im.opt.pdb.bk


cat > cpptraj.in <<ENDOFFILE
parm im.prmtop
trajin im.opt.pdb
reference im.opt.pdb
strip !(:${nt}-${ct}) outprefix std
trajout std.pdb
run
exit
