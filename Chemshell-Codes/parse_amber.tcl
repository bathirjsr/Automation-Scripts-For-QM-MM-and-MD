...
proc amber_type_to_z {type} {
    ...
    switch $type { 
	C - CA - CB  - CC - CK - CM - CN - CP - CQ - CR - CT - CV - CW - C* - C0 - CD - CE - CF - CU - CX - CG - CO - 2C - CZ - 3C { return 6 }
	H  - HC - H1 - H2 - H3 - HA - H4 - H5 - HO - HS - HW - HP - HN - HX { return 1 }
	N  - NA - NB - NC - N2 - N3 - NF - NM - 'N*' - NH - ND - Y3 - NE - NO - Y1 { return 7 }
	O  - OW - OH - OS - O2 - Y2 - OM - Y4 - Y5 - Y6 - Y7 { return 8 }
	SH - SF - SD - SA - SB - SC - SS - S3 - SM { return 16 }
	IM { return 17 }
	IP - IB { return 11 }
        ZN { return 30 }
        FN - F3 - M1 - F4 { return 26 }
	EP { return -1 }
	default {
	    push_banner_flag 0
